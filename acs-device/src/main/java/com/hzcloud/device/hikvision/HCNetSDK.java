...
//设备编码类型配置(NET_DVR_COMPRESSION_AUDIO结构)
    ...
    public static final int NET_DVR_GET_CARD_RIGHT_HOLIDAY_PLAN_V50 = 2310; //获取卡权限假日计划参数V50
    public static final int NET_DVR_SET_CARD_RIGHT_HOLIDAY_PLAN_V50 = 2311; //设置卡权限假日计划参数V50
    public static final int NET_DVR_GET_CARD_RIGHT_HOLIDAY_GROUP_V50 = 2316; //获取卡权限假日组参数V50
    public static final int NET_DVR_SET_CARD_RIGHT_HOLIDAY_GROUP_V50 = 2317; //设置卡权限假日组参数V50
...
//有效期参数结构体
@Structure.FieldOrder({"byEnable","byRes1","struBeginTime","struEndTime","byRes2"})
...
@Structure.FieldOrder({"uLen","struByCard","struByReader"})
...
@Structure.FieldOrder({"dwSize","byEnable","byRes1","struBeginDate","struEndDate","struPlanCfg","byRes2"})
public static class NET_DVR_HOLIDAY_PLAN_CFG extends Structure
{
	...
	public NET_DVR_SINGLE_PLAN_SEGMENT[] struPlanCfg = new NET_DVR_SINGLE_PLAN_SEGMENT[MAX_TIMESEGMENT_V30]; //周计划参数
	public byte[] byRes2 = new byte[16];
}
...
@Structure.FieldOrder({"dwSize","dwHolidayPlanNumber","wLocalControllerID","byRes"})
public static class NET_DVR_HOLIDAY_PLAN_COND extends Structure
{
    public int dwSize;
	public int dwHolidayPlanNumber; //假日计划编号
    public short wLocalControllerID; //就地控制器序号[1,64]
	public byte[] byRes = new byte[106];
}
...
public static final int HOLIDAY_GROUP_NAME_LEN = 32;      //计划模板名称长度
public static final int MAX_HOLIDAY_PLAN_NUM = 16;  //计划模板最大假日组数

@Structure.FieldOrder({"dwSize","byEnable","byRes1","byGroupName","dwHolidayPlanNo","byRes2"})
public static class NET_DVR_HOLIDAY_GROUP_CFG extends Structure
{
	public int dwSize;
	public byte byEnable; //是否启用，1-启用，0-不启用
	public byte[] byRes1 = new byte[3];
	public byte[] byGroupName = new byte[HOLIDAY_GROUP_NAME_LEN]; //假日组名称
	public int[] dwHolidayPlanNo = new int[MAX_HOLIDAY_PLAN_NUM]; //假日计划编号，就前填充，遇0无效
	public byte[] byRes2 = new byte[32];
}
...
@Structure.FieldOrder({"dwSize","dwHolidayGroupNumber","wLocalControllerID","byRes"})
public static class NET_DVR_HOLIDAY_GROUP_COND extends Structure
{
	public int dwSize;
	public int dwHolidayGroupNumber; //假日组编号，从1开始
	public short wLocalControllerID; //就地控制器序号[1,64]，0无效
	public byte[] byRes = new byte[106];
}
