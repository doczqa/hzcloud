  ...
  data() {
    return {
      ...
      rules: {
        ...
        identityId: [
          {  required: true, message: "身份类型未选择", trigger: "change" }
        ],
        idType: [
          {  required: true, message: "证件类型未选择", trigger: "change" }
        ],
        idNumber: [
